//
//  CustomHeaderTableViewTableViewController.swift
//  CustomRefreshView
//
...
class CustomHeaderTableViewTableViewController: UITableViewController {

    var refreshViewObj = UIRefreshControl() // to add refresh control
    ...
    func loadRefreshControl()  {
        ...
        let refreshView = Bundle.main.loadNibNamed("CustomRefreshView", owner: self, options: nil)
        
        let customView = refreshView?[0] as! UIView
        
        customView.frame = refreshViewObj.bounds
